...
let numeroX = parseInt(prompt("Ingresa un número al azar: "));
let contadordenrosImpares = 0;

// colocamos un contador de números impares desde 0 hasta X (inclusive)
for (let i = 0; i <= numeroX; i++) {
    if (i % 2 !== 0) {
        contadordenrosImpares++;
    }
}
// se muestra en consola la cantidad de números impares encontrados
console.log("La cantidad de números impares desde 0 hasta", numeroX, "(inclusive) es:", contadordenrosImpares);
