...
Declarar 4 variables utilizando la palabra reservada let y asignarles valores según el tipo de dato que sugiera su 
nombre. Además, realizar operaciones y validaciones adicionales sobre estos valores.
...
let verdadero = true; // Dato boolean
let texto = "Hola, bienvenido."; // Dato de tipo string
let número = 24; // Dato numérico random
let nada = null; // significa la ausencia de valor en javascript

// Operaciones y Validaciones

// 1. Operación matemática
let resultado = número + 50;
console.log("El resultado de la operación es: " + resultado);

// 2. Concatenación string
texto = (  texto + "¿Cómo estás?" );
console.log(texto);

// 3. Verificación de booleano
if (verdadero) {
